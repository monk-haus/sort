        ...
        <div className="max-w-6xl mx-auto">
          ...
          <section className="relative mb-12">
            ...
            <div className="relative z-10 flex flex-wrap items-center justify-center gap-3 md:gap-6">
              ...
              <a href="https://instagram.com/joinsortlat" target="_blank" rel="noopener noreferrer" className="group relative bg-hot-coral text-white px-5 py-2 md:px-6 md:py-3 rounded-sm font-space-grotesk font-bold text-sm md:text-base border-2 border-deep-violet shadow-hard-sm transition-all duration-300 hover:rotate-0 hover:scale-105 hover:shadow-hard hover:z-20" style={{ transform: "rotate(-2deg)" }}>[ Instagram ]</a>
            </div>
          </section>
